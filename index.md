...
* [Boost](http://www.boost.org/) for image data processing
...
### Wiimote
A Wiimote controller was used to facilitate the experiment and save waypoint coordinates with sensor input from the SICK LMS. The program used the ROS [wiimote package](http://wiki.ros.org/wiimote) to communicate over a Bluetooth connection, returning button, LED, rumble, and accelerometer/gyro data on the /joy ROS node.
...
## Results
My work with the Deixis project contributed to this [publication](http://robotics.usc.edu/publications/media/uploads/pubs/731.pdf), which contains a statistical data analysis of the experiments.
