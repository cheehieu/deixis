...
//Subscribes to video2bag/image topic Image messages
//Converts to opencv image and constructs a video
//Writes to a filename (arg[1]), default is "out.avi"
//Framerate is set to 15fps
...
int main(int argc, char **argv)
{
    ...
    image_transport::Subscriber sub = it.subscribe("video2bag/image", 1, &image_handler);

    cvNamedWindow("write_video", CV_WINDOW_AUTOSIZE);
