source("~/Desktop/scripts/GetCalPts.R")
...
head_calib_near = subset(data, modality=="1" & target_desired_y=="9")
arm_calib_near = subset(data, modality=="4" & target_desired_y=="9")
cross_calib_near = subset(data, modality=="4" & target_desired_y=="-9")
head_calib_far = subset(data, modality=="1" & target_desired_y=="-27")
arm_calib_far = subset(data, modality=="4" & target_desired_y=="27")
cross_calib_far = subset(data, modality=="4" & target_desired_y=="-27")
...
par(mfrow=c(2,2))
plot(density(head_near_per_des_error_y, kernel="gaussian"), xlim=c(-40,40), ylim=c(0,0.3), col=2, xlab="Horizontal Error (inches)", main="Error PDF, near calibration point")
...
legend(x="topright", c("head", "arm", "bent arm"), col=c(2,3,4), pch=15)
plot(density(head_far_per_des_error_z, kernel="gaussian"), xlim=c(-40,40), ylim=c(0,0.3), col=2, xlab="Vertical Error (inches)", main="Error PDF, far calibration point")
lines(density(arm_far_per_des_error_z, kernel="gaussian"), col=3)
lines(density(cross_far_per_des_error_z, kernel="gaussian"), col=4)
legend(x="topright", c("head", "arm", "bent arm"), col=c(2,3,4), pch=15)
plot(density(head_near_per_des_error_z, kernel="gaussian"), xlim=c(-40,40), ylim=c(0,0.3), col=2, xlab="Vertical Error (inches)", main="Error PDF, near calibration point")
...
legend(x="topright", c("head", "arm", "bent arm"), col=c(2,3,4), pch=15)
plot(density(head_far_per_des_error_y, kernel="gaussian"), xlim=c(-40,40), ylim=c(0,0.3), col=2, xlab="Horizontal Error (inches)", main="Error PDF, far calibration point")
...
plot(head_data$target_head_actual_y, head_data$target_head_actual_z, xlim=c(-80,80), ylim=c(0,100))
dev.off()
pdf("~/Desktop/figs/target_agg_arm_actual.pdf")
plot(arm_data$target_arms_actual_y, arm_data$target_arms_actual_z, xlim=c(-80,80), ylim=c(0,100))
dev.off()
...
pdf("~/Desktop/figs/actual_perceived_arm.pdf")
plot(arm_data$target_arms_actual_y, arm_data$target_arms_actual_z, xlim=c(-80,80), ylim=c(0,100), col="blue")
 points(arm_data$target_desired_y, arm_data$target_desired_z, xlim=c(-80,80), ylim=c(0,100), col="green")
 points(arm_data$target_perceived_y,arm_data$target_perceived_z, xlim=c(-80,80), ylim=c(0,100), col="orange", pch=1)
dev.off()

pdf("~/Desktop/figs/head_y_des_actual.pdf")
plot(head_data$target_desired_y, head_data$target_head_actual_y, col="blue", asp=1, xlab="Desired Target Value (in.)", ylab="Actual Target Value (in.)", main="Actual vs. Desired error")
points(arm_data$target_desired_y, arm_data$target_arms_actual_y, col="green", xlab="Desired Target Value (in.)", ylab="Actual Target Value (in.)")
abline(0,1)
dev.off()

pdf("~/Desktop/figs/head_y_des_per.pdf")
plot(head_data$target_desired_y, head_data$target_head_perceived_y, col="blue", asp=1, xlab="Desired Target Value (in.)", ylab="Perceived Target Value (in.)", main="Perceived vs. Desired error")
points(arm_data$target_desired_y, arm_data$target_perceived_y, col="green", xlab="Desired Target Value (in.)", ylab="Perceived Target Value (in.)")
abline(0,1)
dev.off()
